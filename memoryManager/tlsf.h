 ...
 *  \file tlsf.h
 *
 *  \brief Memory manager interface file
 *
 *  In this file will included the basic memory management routines based on
 *  tlsf alghoritm written by Matthew Conte and based on original idea of
 *  Miguel Masmano.
 *
 *  Author: FSN
 *
